    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12  '>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>Our vision at Prescripto is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.
          </p>
      ...
      <div className=' flex flex-col md:flex-row  '>
        <div className='flex flex-col  items-start justify-center  border-2 border-gray-300 p-16 gap-5 ' >
          <b>Efficiency:</b>
