...
const Doctors = () => {
  ...
  const applyFilter=()=>{
    if(speciality){
      const filtered=doctors.filter(item=>item.speciality.toLowerCase()===speciality.toLowerCase());
  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={` flex-col gap-4 text-sm text-gray ${showFilter?"flex":"hidden sm:flex"} `}>
